//These are a set of optimized sensor drivers for specific sensors
...
#define LSM303_IRA_REG_M              (0x0A)
  ...
  //set the gain based on whether or not the magnetic switch capability is enabled
...
#define LSM9DS1_REGISTER_CTRL_REG4_M         (0x23)
  ...
  if(settings.magSwitchEnable){
    //Set gain to 8 Gauss
      ...
      mag.gainX = mag.gainY = mag.gainZ = (float)(0.29 / 1000);
      mag.biasX /= 2;
      mag.biasY /= 2;
      mag.biasZ /= 2;}
  else{
